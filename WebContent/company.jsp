    ...
    <div class="panel panel-default">
      ...
      <input type="hidden" name="securityCode" value="<%=request.getParameter("id")%>">
        ...
        <div class="input-group col-sm-10 m-b">
          <input type="number" name="quantity" placeholder="" class="form-control text-right">
        </div>
        <div class="m-t-9">
          <label class="col-sm-2 control-label m-t-9">Bid</label>
          <div class="input-group col-sm-10 m-b">
            <input type="number" name="priceOfSecurity" placeholder="" class="form-control text-right">
          </div>
        </div>
        <div class="row">
        ...
        <div class="m-t-9">
          <button name="direction" type="submit" value="buy" style="background-color:#337ab7;border-color:#2e6da4;font-size:14px" type="button" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Buy Stock</button>
        </div>
        </form>
      </div>
...
<div class="col-lg-7" style="margin-left:140px">
    <div class="panel panel-default">
      ...
      <div class="panel-wrapper collapse in" aria-expanded="true" style=""><div class="pannel panel-body">
        ...
        <div class="input-group col-sm-10 m-b">
          <input type="text" placeholder="" name="quantity" class="form-control text-right">
        </div>
        <div class="m-t-9">
          <label class="col-sm-2 control-label m-t-9">Ask</label>
          <div class="input-group m-b">
            <input type="number" name="priceOfSecurity" class="form-control text-right" placeholder="">
          </div>
        </div>
        <div class="row">
          <div class="btn-group m-t-9 col-md-6 col-sm-12 col-xs-12">
